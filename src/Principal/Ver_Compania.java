 ...
 * 
 */
public class Ver_Compania extends javax.swing.JFrame {
...
switch(Index){
    ...
    case 1: 
        ...
        resultado = Conexion.consulta("Select * from [dbo].[Compania] where [ID_Compania] = "+Buscar);
...
break;
    ...
    case 2: 
        ...
        resultado = Conexion.consulta("Select *  from  [dbo].[Compania] where [Actividades] = '"+Buscar+"'");
...
switch(Index){
    ...
    case 1: 
        ...
        resultado = Conexion.consulta("Select * from [dbo].[Compania] where  [ID_Compania]  like '"+Buscar+"%'");
...
break;
    ...
    case 2: 
        ...
        resultado = Conexion.consulta("Select * from [dbo].[Compania] where [Actividades] like '"+Buscar+"%'");
...
if(evt.getClickCount() == 2){
    ...
    if(Index != -1){
        ...
        Modificar_Compania MC = new Modificar_Compania(this, true);
...
int Index = jTable1.getSelectedRow();
    ...
    if(Index != -1){
        ...
        Compania.Eliminar_Compania(IDD);
...
public void ActualizarTabla(){
        ...
        resultado = Conexion.consulta("Select * from [dbo].[Compania]");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Compania.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Compania().setVisible(true);
            }
        });
    }
